...
/**   
   Description: This class tests various cases for different inputs to a Stack. 
**/
import java.io.*;
...
public class TestStack {
   public static void main(String[] args) {
      ...
      // Test4
      assertTrue("Test4.0", (Character) l1.top() == '6');
      assertTrue("Test4.1", (Character) l1.pop() == '6');
      assertTrue("Test4.2", (Character) l1.pop() == '0');
      assertTrue("Test4.3", (Character) l1.pop() == '2');
      assertTrue("Test4.4", l1.toString().equals("{t,i}"));
      assertTrue("Test4.5", l1.isEmpty() == false);
      assertTrue("Test4.6", l1.size() == 2);
      assertTrue("Test4.7", (Character) l1.pop() == 't');
      assertTrue("Test4.8", (Character) l1.pop() == 'i');
