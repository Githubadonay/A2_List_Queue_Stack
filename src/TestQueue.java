/**
   Description: This class tests various cases for different inputs to a Queue. 
**/
public class TestQueue { 
   public static void main (String[] args) {
   
      // Test1
      Queue l1 = new Queue <Character> ();
      ...
      // Test4
      assertTrue("Test4.0", (Character)l1.first()=='a');
      assertTrue("Test4.1", (Character)l1.dequeue()=='a');
      assertTrue("Test4.2", (Character)l1.dequeue()=='l');
      assertTrue("Test4.3", (Character)l1.dequeue()=='g');
